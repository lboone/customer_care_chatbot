...
export const metadata: Metadata = {
  title: "Customer Care Chatbot - Human Friendly AI",
  description:
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${inter.variable} bg-[#050509] min-h-screen flex flex-col p-0 antialiased
        text-zinc-100 selection:bg-zinc-800 font-sans`}
      >
