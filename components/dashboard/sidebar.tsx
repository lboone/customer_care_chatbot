...
const SIDEBAR_ITEMS = [
  ...
  { label: "Knowledge", href: "/dashboard/knowledge", icon: BookOpenIcon },
  { label: "Sections", href: "/dashboard/sections", icon: LayersIcon },
  { label: "Chatbot", href: "/dashboard/chatbot", icon: BotIcon },
  {
    label: "Conversations",
      ...
      <div className="p-4 border-t border-white/5">
        <div className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-white/5 cursor-pointer transition-colors group">
          ...
          <div className="flex flex-col overflow-hidden">
            <span className="text-sm font-medium text-zinc-300 truncate group-hover">
              {isLoading
                ? "Loading..."
