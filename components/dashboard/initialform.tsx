...
const STEPS = [
  {
    ...
    description: "Thiw will be the identity of your Organization.",
    icon: Building2Icon,
  ...
  },
  {
    ...
    description:
      "Add external links like Notion pages or Help docs to help your chatbot learn more.",
    icon: LinkIcon,
        ...
        <div className="flex flex-col items-center justify-center text-center animate-in fade-in duration-700">
          <div className="relative mb-8">
            ...
            <div className="relative w-16 h-16 bg-linear-to-tr from-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center shadow-lg shadow-indigo-500/20">
              <SparklesIcon className="w-8 h-8 text-white animate-bounce" />
            </div>
          </div>
            ...
            <div className="flex items-center gap-2">
              {currentStep > 0 && (
                <Button
                  ...
                  size="icon"
                  onClick={handleBack}
                  className="text-zinc-500 hover:text-zinc-300 hover:bg-white/5 rounded-full -ml-2 w-8 h-8 cursor-pointer"
                >
                  <ChevronLeftIcon className="w-5 h-5" />
                </Button>
              )}
              <span className="text-xs font-medium text-indigo-400 uppercase tracking-wider bg-indigo-500/10 px-2 py-1 rounded-2xl border border-indigo-500/20 text-center">
