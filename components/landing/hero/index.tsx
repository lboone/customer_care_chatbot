import { ArrowRightIcon, SendIcon, UserIcon } from "lucide-react";
import Image from "next/image";

const Hero = () => {
  return (
    <section className="relative pt-32 pb-20 md:pb-32 px-6 overflow-hidden">
      <div className="max-w-4xl mx-auto text-center relative z-20">
        ...
        <h1 className="text-5xl md:text-7xl font-medium tracking-light text-white mb-6 leading-[1.1]">
          ...
          <div className="flex flex-col h-125 md:h-150 w-full bg-[#0a0a0e] rounded-xl overflow-hidden">
              ...
              <div className="flex w-full flex-col items-start gap-3">
                ...
                <div className="flex w-full flex-col items-end">
                  <div className="flex max-w-[85%] gap-3 flex-row-reverse">
                    ...
                    <div className="p-4 rounded-2xl text-sm leading-relaxed shadow-sm bg-zinc-800 text-zinc-200 rounded-tr-sm">
                      I need some information about Customer Care Chatbot stack
                    </div>
                  </div>
                </div>
                <div className="flex-w-full flex-col items-start">
                  <div className="flex max-w-[85%] gap-3 flex-row">
                    ...
                    <div className="p-4 rounded-2xl text-sm leading-relaxed shadow-sm bg-white text-zinc-900 rounded-tl-sm">
                      Customer Care Chatbot stack is an integrated ecosystem
                      designed to enhance developer efficiency. It includes
                      tools like Customer Care Chatbot Logs for real-time
                      monitoring and Becodemy for community support.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="p-4 bg-[#0A0A0E] border-t border-white/5 shrink-0">
              <div className="relative">
                <div className="min-h-12.5 w-full px-4 py-3 text-sm bg-zinc-900/50 border border-white/10 flex items-center justify-between rounded-xl text-zinc-500">
