      ...
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-16">
        <div className="flex-1">
          ...
          <div className="flex flex-col gap-4">
            <Integrate
              title="1"
              description="Scan your documentation URL"
              showArror={true}
            />

            <Integrate
              title="2"
              description="Copy the embed snippet"
              showArror={true}
            />
            <Integrate title="3" description="Auto-resolve tickets" />
          </div>
        </div>
        <div className="flex-1 w-full max-w-lg">
          <div className="glass-card rounded-xl p-6 relative">
            ...
            <div className="font-mono text-xs md:text-sm leading-y text-zinc-400 flex flex-col gap-1">
              ...
              <div className="pl-4">
                ...
                <span className="text-emerald-400">
                  &quot;https://customercarechatbot.com/init.js&quot;
                </span>
              </div>
...
const Integrate = ({
  ...
  return (
    <>
      ...
      {showArror && <div className="w-px h-4 bg-zinc-800 ml-3"></div>}
    </>
  );
};
